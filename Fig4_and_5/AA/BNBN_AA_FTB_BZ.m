...
figure1.Position=[F1 F2 F3 F4];
savefig(figure1,'AA-sCB_1.fig','compact')
...
F1=700;F2=600;F3=700;F4=600;
figure1.Position=[F1 F2 F3 F4];
savefig(figure1,'AA-sVB_1.fig','compact')
%% 
...
F1=700;F2=600;F3=700;F4=600;
figure2.Position=[F1 F2 F3 F4];
savefig(figure2,'AA-VB_1.fig','compact')
...
F1=700;F2=600;F3=700;F4=600;
figure3.Position=[F1 F2 F3 F4];
savefig(figure3,'AA-CB_1.fig','compact')
%}
