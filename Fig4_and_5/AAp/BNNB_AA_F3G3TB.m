...
fdata(:,1) = tfab; 
fdata(:,2) = tfbpap;
dlmwrite('fdata_AAp_bBN_jsv.dat',fdata)

gdata(:,1) = tgaa; 
gdata(:,2) = tgbb; 
gdata(:,3) = tgapap;
gdata(:,4) = tgbpbp;
dlmwrite('gdata_AAp_bBN_jsv.dat',gdata)
...
fdatan(:,1) = tfabn; 
fdatan(:,2) = tfbpapn;
dlmwrite('nn_fdata_AAp_bBN_jsv.dat',fdatan)

gdatan(:,1) = tgaan; 
gdatan(:,2) = tgbbn; 
gdatan(:,3) = tgapapn;
gdatan(:,4) = tgbpbpn;
dlmwrite('nn_gdata_AAp_bBN_jsv.dat',gdatan)
...
Ef = -0.1475;%-0.1620;%-0.1330;
Efn =  -0.1475;%-0.1620;%-0.1330;
