...
hbbp =@(kx,ky) conj(a1F_kxky(kx,ky,tfbpb));
haap =@(kx,ky) conj(a1F_kxky(kx,ky,tfapa));
hbap =@(kx,ky) (a1F_kxky(kx,ky,tfbap));
habp =@(kx,ky) a1G_kxky(kx,ky,tgabp); 
...
figure1.Position=[F1 F2 F3 F4];
savefig(figure1,'BAp-sCB_1.fig','compact')
%%
figure1 = figure;
colormap(jet);
axes1 = axes('Parent',figure1);
...
F1=700;F2=600;F3=700;F4=600;
figure1.Position=[F1 F2 F3 F4];
savefig(figure1,'BAp-sVB_1.fig','compact')
%% 
...
F1=700;F2=600;F3=700;F4=600;
figure2.Position=[F1 F2 F3 F4];
savefig(figure2,'BAp-VB_1.fig','compact')
%%
figure3 = figure;
axes3 = axes('Parent',figure3);
hold(axes3,'on');
...
F1=700;F2=600;F3=700;F4=600;
figure3.Position=[F1 F2 F3 F4];
savefig(figure3,'BAp-CB_1.fig','compact')
%}