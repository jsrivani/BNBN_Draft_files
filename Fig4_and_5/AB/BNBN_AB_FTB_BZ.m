...
figure1.Position=[F1 F2 F3 F4];
savefig(figure1,'AB-sCB_1.fig','compact')
%%
figure1 = figure;
colormap(jet);
axes1 = axes('Parent',figure1);
...
F1=700;F2=600;F3=700;F4=600;
figure1.Position=[F1 F2 F3 F4];
savefig(figure1,'AB-sVB_1.fig','compact')
%% 
...
F1=700;F2=600;F3=700;F4=600;
figure2.Position=[F1 F2 F3 F4];
savefig(figure2,'AB-VB_1.fig','compact')
%%
figure3 = figure;
axes3 = axes('Parent',figure3);
hold(axes3,'on');
...
F1=700;F2=600;F3=700;F4=600;
figure3.Position=[F1 F2 F3 F4];
savefig(figure3,'AB-CB_1.fig','compact')
%}